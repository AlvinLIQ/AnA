...
namespace AnA
{
    ...
    public:
        ...
        VkResult AcquireNextImage(uint32_t* pImageIndex)
        {
            ...
            return vkAcquireNextImageKHR(aDevice->GetLogicalDevice(), swapChain, UINT64_MAX, imageAvailableSemaphores[CurrentFrame], VK_NULL_HANDLE, pImageIndex);
        }
    ...
    private:
        ...
        void createFramebuffers()
        {
            ...
            for (size_t i = 0; i < swapChainImageViews.size(); i++)
            {
                ...
                if (vkCreateFramebuffer(aDevice->GetLogicalDevice(), &framebufferInfo, nullptr, &swapChainFramebuffers[i]) != VK_SUCCESS) {
