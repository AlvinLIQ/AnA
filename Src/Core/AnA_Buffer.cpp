...
using namespace AnA;
AnA_Buffer::AnA_Buffer(AnA_Device *&mDevice, VkDeviceSize size, VkBufferUsageFlags usage, VkMemoryPropertyFlags properties) : aDevice {mDevice}
{
