...
void AnA_Instance::createInstance()
{
...
std::vector<const char *> AnA_Instance::getGLFWExtensions()
{
...
bool AnA_Instance::checkExtensions(std::vector<const char *> targetExtensions)
{
...
bool AnA_Instance::checkValidationLayerSupport()
{
    uint32_t layerCount;
...
VKAPI_ATTR VkBool32 VKAPI_CALL AnA_Instance::debugCallback(VkDebugUtilsMessageSeverityFlagBitsEXT messageSeverity,
...
VkResult AnA_Instance::CreateDebugUtilsMessengerEXT(VkInstance instance, const VkDebugUtilsMessengerCreateInfoEXT *pCreateInfo,
...
void AnA_Instance::DestroyDebugUtilsMessengerEXT(VkInstance instance, VkDebugUtilsMessengerEXT debugMessenger,
                                   const VkAllocationCallbacks *pAllocator)
{
...
void AnA_Instance::setupDebugMessenger()
{
    if (!enableValidationLayers)
        return;
