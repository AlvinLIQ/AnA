...
VkCommandBuffer AnA_Renderer::BeginFrame()
{
...
void AnA_Renderer::BeginSwapChainRenderPass(VkCommandBuffer commandBuffer)
{
...
void AnA_Renderer::EndSwapChainRenderPass(VkCommandBuffer commandBuffer)
{
...
void AnA_Renderer::createCommandBuffers()
{
