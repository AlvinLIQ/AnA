...
bool AnA::Physics::IsCollided(Object& object1, Object& object2)
{
    return IsCollided(object1.Model->GetVertexProjections().data(), object1.Model->GetTransforms().data(), 
                            object1.Model->GetVertexProjections().size(), object1.Transform.scale.y, 
                            object1.Transform.translation, object2.Model->GetVertices().data(), object2.Model->GetVertices().size(),
                            object2.Transform.translation, object2.Transform.scale.y);
}
