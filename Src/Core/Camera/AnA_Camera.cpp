...
void AnA_Camera::SetPerspectiveProjection(float fovy, float aspect, float near, float far)
{
...
void AnA_Camera::SetViewTarget(glm::vec3 position, glm::vec3 target, glm::vec3 up)
{
    SetViewDirection(position, target - position, up);
}

void AnA_Camera::SetViewYXZ(glm::vec3 position, glm::vec3 rotation)
{
...
{
    viewMatrix[0] += -position.x;
    viewMatrix[1] += -position.y;
