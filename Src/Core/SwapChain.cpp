...
void SwapChain::createOffscreenRenderPass()
{
	...
	attachmentDescription.finalLayout = VK_IMAGE_LAYOUT_DEPTH_ATTACHMENT_STENCIL_READ_ONLY_OPTIMAL;// Attachment will be transitioned to shader read at render pass end
