...
{
    aDevice->CreateDescriptorPool(descriptorSetCount, descriptorCount * bindingCount, pool, descriptorType, VK_DESCRIPTOR_SET_LAYOUT_CREATE_UPDATE_AFTER_BIND_POOL_BIT);
